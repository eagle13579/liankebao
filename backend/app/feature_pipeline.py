...
STOP_WORDS: set[str] = {
    ...
    "它", "们", "为", "与", "及", "等", "或", "之", "以", "被",
    "让", "给", "对", "从", "把", "向", "能", "做", "用", "买",
    "卖", "找", "寻", "求", "供", "需", "可以", "需要", "能够",
    "应该", "这个", "那个", "什么", "如何", "怎么", "我们", "他们",
    "你们", "已经", "还是", "因为", "所以", "如果", "虽然", "但是",
    "而且", "或者", "并且", "不仅", "以及", "关于", "对于", "根据",
    "按照", "通过", "经过", "进行", "例如", "比如", "希望", "想要",
    "目前", "现在", "未来", "主要", "相关", "包括", "具有", "提供",
    "支持", "实现", "开发", "服务", "系统", "平台", "方案", "项目",
    "产品", "品牌",
}

# 已知类目列表（用于 one-hot / multi-label 编码）
KNOWN_CATEGORIES: list[str] = [
    "大健康", "食品", "企业服务", "企业家服务", "教育培训",
    "科技产品", "SaaS硬件", "消费品", "工业", "农业",
    "文化传媒", "金融", "房地产", "物流", "医疗",
    "其他",
]
...
def compute_similarity(
    ...
    # 加权综合
    final_score = (
        0.45 * cat_sim + 0.35 * text_sim + 0.15 * price_budget_sim + 0.05 * recency_sim
    )
