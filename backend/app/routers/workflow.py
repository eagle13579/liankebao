...
适配说明:
  从旧版 modules/workflow/routes/__init__.py 迁移到 chainke-full app/routers/workflow.py。
  导入路径已适配: modules.workflow → features.workflow
"""
import json
import logging
...
from features.workflow.workflow_engine import WorkflowEngine, RuleNotFoundError
