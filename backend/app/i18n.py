...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "缺少 Authorization 头，请先登录": {"zh": "缺少 Authorization 头，请先登录", "en": "Missing Authorization header, please login first"},
    "Token 无效或已过期，请重新登录": {"zh": "Token 无效或已过期，请重新登录", "en": "Token invalid or expired, please login again"},
    ...
    # ── trust network (信任网络) ──
    "无权操作其他用户的信任网络": {"zh": "无权操作其他用户的信任网络", "en": "No permission to modify other users' trust network"},
    ...
    "链客宝桥接模块未加载，同步跳过": {"zh": "链客宝桥接模块未加载，同步跳过", "en": "Chainke bridge module not loaded, sync skipped"},
    "链客宝同步完成": {"zh": "链客宝同步完成", "en": "Chainke sync completed"},
    ...
    # ── chainke (链客宝) ──
    "链客宝数据同步中": {"zh": "链客宝数据同步中", "en": "Syncing Chainke data"},
    "链客宝同步失败": {"zh": "链客宝同步失败", "en": "Chainke sync failed"},
