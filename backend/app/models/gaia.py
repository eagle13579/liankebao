...
class GaiaEvolutionEvent(Base):
    ...
    def __repr__(self) -> str:
        return f"<GaiaEvolutionEvent id={self.id} type={self.event_type!r} source={self.event_source!r}>"
...
class GaiaTrainingRun(Base):
    ...
    __table_args__ = (Index("idx_gaia_training_status", "status", "created_at"),)

    def __repr__(self) -> str:
        return f"<GaiaTrainingRun id={self.id} status={self.status!r} trigger={self.trigger!r}>"
...
class GaiaModelWeights(Base):
    ...
    __table_args__ = (Index("idx_gaia_weights_module_active", "module", "is_active", "version"),)

    def __repr__(self) -> str:
        return (
            f"<GaiaModelWeights id={self.id} module={self.module!r} version={self.version!r} active={self.is_active}>"
        )
