...
@app.get("/api/brochures/{user_id:path}")
...
@app.post("/api/brochures", status_code=201)
...
@app.put("/api/brochures/{user_id:path}")
...
@app.delete("/api/brochures/{user_id:path}")
...
@app.get("/api/brochures/{user_id:path}/trust_network")
...
@app.post("/api/brochures/{user_id:path}/trust_network")
...
@app.delete("/api/brochures/{user_id:path}/trust_network")
...
@app.get("/api/brochures/{user_id:path}/matches")
...
@app.get("/api/brochure/{brochure_id}/brochure", response_class=HTMLResponse)
...
@app.get("/api/brochure/{brochure_id}/visitors")
...
@app.get("/api/brochure/{brochure_id}/qrcode")
...
@app.get("/api/brochure/sync/chainke")
...
@app.post("/api/brochure/batch-import", status_code=201)
