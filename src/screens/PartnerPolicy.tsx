...
const faqs: FaqItem[] = [
  {
    q: '什么是流量合伙人？',
    a: '流量合伙人即链客宝推广员。您只需推荐企业免费入驻链客宝，企业上架产品时自行设置分润比例（如5%），您推广该产品成交后即可获得销售额×分润比例的佣金。无需囤货、无需售后，推广赚钱就是这么简单。',
  },
  {
    q: '注册成为流量合伙人需要付费吗？',
    a: '完全免费，零门槛。链客宝不收取任何注册费、入门费、保证金。注册即获得专属推广码，分享即可赚取佣金。',
  },
  {
    q: '分润比例是谁设定的？',
  ...
  {
    q: '我是企业，如何入驻并设置分润？',
    a: '3步走：① 注册链客宝账号 ② 上架产品时在"推广分润比例"栏输入您愿意支付的百分比（如5%） ③ 提交审核上架。之后所有推广员都会看到您的产品，推广成交后平台自动计算分润。',
  },
  {
    q: '客户退款了怎么办？',
  ...
  {
    q: '推广方式有哪些？',
    a: '多种方式：社交分享（朋友圈发产品海报）、私聊推荐（一对一推荐给潜在客户）、线下展示（带样品参加活动）、内容引流（抖音/小红书做内容挂链接）。链客宝为您提供专属推广码和推广素材。',
  },
  {
    q: '为什么选择链客宝流量合伙人模式？',
      ...
      <main className="max-w-3xl mx-auto w-full p-4">
            ...
            <div className="flex gap-3 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  推广员（流量合伙人）推荐企业免费入驻链客宝平台，获取专属推广码。
                </p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-sky-50 to-sky-50/30 border border-sky-100/50 rounded-2xl p-5 text-center">
          ...
          <p className="text-xs text-sky-700/80">
            更多详细内容请联系链客宝运营客服，或查看平台公告了解最新政策。
          </p>
        </div>
      </main>
    </div>
