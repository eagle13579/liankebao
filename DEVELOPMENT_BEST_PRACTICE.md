...
> 项目: 链客宝AI (FastAPI + React 19 + Vite 6)
...
| 环境 | 角色 | 放什么 | 不放什么 |
|:-----|:-----|:-------|:---------|
| **D:\链客宝AI\** | 代码唯一真相源 | 源码/部署脚本/git/ARCHITECTURE | AI会话记录、技能缓存 |
...
| 层级 | 目录 | 内容 | 更新时机 |
|:-----|:-----|:------|:---------|
| **L1** 图书馆 | L1图书馆/代码资产库/链客宝AI/ | 代码架构快照、模块结构、接口文档 | 每次大功能完成 |
...
### B: 代码在项目
所有代码改动在 D:\链客宝AI\ 下完成，不在记忆宫殿里写代码。
```
cd D:\链客宝AI\
...
| 服务 | 端口 | 路径 |
|:-----|:----:|:------|
| 旧后端(退役中) | 8000 | D:/链客宝AI/backend/ |
| 新后端(主服务) | 8001 | D:/链客宝AI/backend_v2/ |
| AI数字名片 | 8003 | 记忆宫殿/L5/数字名片/ |
| 统一网关 | 5136 | 记忆宫殿/L5/链客宝AI/统一API网关.py |
| 前端(Vite开发) | 5173 | D:/链客宝AI/ |
